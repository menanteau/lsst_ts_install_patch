...
export LSSTTS_SALOBJ_VERSION=5.8.0
export LSSTTS_XML_VERSION=5.0.0
export LSSTTS_IDL_VERSION=1.1.3
export CCS_IDL_LIST="ATHeaderService ATCamera ATArchiver ATPtg ATMCS ATSpectrograph ATTCS ATHexapod ATDome DIMM CCArchiver CCCamera CCHeaderService"
